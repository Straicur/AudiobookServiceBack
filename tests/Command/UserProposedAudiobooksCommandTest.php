...
class UserProposedAudiobooksCommandTest extends AbstractKernelTestCase
{
    public function test_userProposedAudiobooksSuccess()
    {
        ...
        $audiobook5 = $this->databaseMockManager->testFunc_addAudiobook('t5', 'a', '2', 'd', new DateTime(), 20, '20', 2, 'desc', AudiobookAgeRange::ABOVE18, 'd5', [$category2, $category3], null, (new DateTime())->modify('- 1 month'), active: true);
        ...
        $audiobook8 = $this->databaseMockManager->testFunc_addAudiobook('t8', 'a', '2', 'd', new DateTime(), 20, '20', 2, 'desc', AudiobookAgeRange::ABOVE18, 'd8', [$category4], active: true);
        ...
        $audiobook13 = $this->databaseMockManager->testFunc_addAudiobook('t13', 'a', '2', 'd', new DateTime(), 20, '20', 2, 'desc', AudiobookAgeRange::ABOVE18, 'd13', [$category1], null, (new DateTime())->modify('- 1 month'), active: true);
        ...
        $audiobook16 = $this->databaseMockManager->testFunc_addAudiobook('t16', 'a', '2', 'd', new DateTime(), 20, '20', 2, 'desc', AudiobookAgeRange::ABOVE18, 'd16', [$category8], active: true);
        $audiobook17 = $this->databaseMockManager->testFunc_addAudiobook('t17', 'a', '2', 'd', new DateTime(), 20, '20', 2, 'desc', AudiobookAgeRange::ABOVE18, 'd17', [$category7], active: true);
        $audiobook18 = $this->databaseMockManager->testFunc_addAudiobook('t18', 'a', '2', 'd', new DateTime(), 20, '20', 2, 'desc', AudiobookAgeRange::ABOVE18, 'd18', [$category7, $category5], null, (new DateTime())->modify('- 1 month'), active: true);
        $audiobook19 = $this->databaseMockManager->testFunc_addAudiobook('t19', 'a', '2', 'd', new DateTime(), 20, '20', 2, 'desc', AudiobookAgeRange::ABOVE18, 'd19', [$category8], active: true);
        $audiobook20 = $this->databaseMockManager->testFunc_addAudiobook('t20', 'a', '2', 'd', new DateTime(), 20, '20', 2, 'desc', AudiobookAgeRange::ABOVE18, 'd20', [$category1], active: true);
        ...
        $audiobook24 = $this->databaseMockManager->testFunc_addAudiobook('t24', 'a', '2', 'd', new DateTime(), 20, '20', 2, 'desc', AudiobookAgeRange::ABOVE18, 'd24', [$category1, $category2], null, (new DateTime())->modify('- 1 month'), active: true);
