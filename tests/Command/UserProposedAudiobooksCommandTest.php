...
class UserProposedAudiobooksCommandTest extends AbstractKernelTestCase
{
    public function test_userProposedAudiobooksSuccess()
    {
        ...
        $audiobook6 = $this->databaseMockManager->testFunc_addAudiobook("t6", "a", "2", "d", new \DateTime("Now"), "20", "20", 2, "desc", AudiobookAgeRange::ABOVE18,  "d6",  [$category5], active: true);
        ...
        $audiobook12 = $this->databaseMockManager->testFunc_addAudiobook("t6", "a", "2", "d", new \DateTime("Now"), "20", "20", 2, "desc", AudiobookAgeRange::ABOVE18,  "d12",  [$category5], active: true);
