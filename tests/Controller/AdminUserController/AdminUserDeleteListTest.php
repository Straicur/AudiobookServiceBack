...
class AdminUserDeleteListTest extends AbstractWebTest
{
    ...
    public function test_userSettingsDeleteCorrect(): void
    {
        ...
        $user3 = $this->databaseMockManager->testFunc_addUser("User", "Test", "test@cos.pl", "+48123123123", ["Guest", "User",], true, "zaq12wsx");
        $user4 = $this->databaseMockManager->testFunc_addUser("User", "Test", "test@cos.pl", "+48123123123", ["Guest", "User",], true, "zaq12wsx");
