...
class UserAudiobooksTest extends AbstractWebTest
{
    ...
    public function test_userAudiobooksParentControlCorrect(): void
    {
        ...
        $audiobook1 = $this->databaseMockManager->testFunc_addAudiobook("t1", "a", "2", "d", new \DateTime("Now"), "20", "20", 2, "desc", AudiobookAgeRange::FROM3TO7, "d1", [$category1, $category2], active: true);
        $audiobook2 = $this->databaseMockManager->testFunc_addAudiobook("t2", "a", "2", "d", new \DateTime("Now"), "20", "20", 2, "desc", AudiobookAgeRange::FROM3TO7, "d2", [$category2], active: true);
        $audiobook3 = $this->databaseMockManager->testFunc_addAudiobook("t3", "a", "2", "d", new \DateTime("Now"), "20", "20", 2, "desc", AudiobookAgeRange::FROM7TO12, "d3", [$category2], active: true);
        $audiobook4 = $this->databaseMockManager->testFunc_addAudiobook("t4", "a", "2", "d", new \DateTime("Now"), "20", "20", 2, "desc", AudiobookAgeRange::ABOVE18, "d4", [$category1, $category2], active: true);
        ...
        $audiobook6 = $this->databaseMockManager->testFunc_addAudiobook("t6", "a", "2", "d", new \DateTime("Now"), "20", "20", 2, "desc", AudiobookAgeRange::FROM12TO16, "d6", [$category5]);
        $audiobook7 = $this->databaseMockManager->testFunc_addAudiobook("t7", "a", "2", "d", new \DateTime("Now"), "20", "20", 2, "desc", AudiobookAgeRange::FROM16TO18, "d7", [$category1, $category4], active: true);
        $audiobook8 = $this->databaseMockManager->testFunc_addAudiobook("t8", "a", "2", "d", new \DateTime("Now"), "20", "20", 2, "desc", AudiobookAgeRange::FROM16TO18, "d8", [$category4]);
        $audiobook9 = $this->databaseMockManager->testFunc_addAudiobook("t9", "a", "2", "d", new \DateTime("Now"), "20", "20", 2, "desc", AudiobookAgeRange::ABOVE18, "d9", [$category4], active: true);
