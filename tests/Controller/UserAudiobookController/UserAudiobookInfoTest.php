...
class UserAudiobookInfoTest extends AbstractWebTest
{
     ...
     * @return void
     */
    public function test_userAudiobookInfoCorrect(): void
    {
        /// step 1
        ...
        /// step 2
        $crawler = self::$webClient->request('POST', '/api/user/audiobook/info', server: [
    ...
    /**
     * step 1 - Preparing data
     * step 2 - Preparing JsonBodyContent without AudiobookInfo
     * step 3 - Sending Request
     * step 4 - Checking response
     *
     * @return void
     */
    public function test_userAudiobookInfoIncorrectNoInfo(): void
    {
        /// step 1
        $user = $this->databaseMockManager->testFunc_addUser('User', 'Test', 'test@cos.pl', '+48123123123', ['Guest', 'User', 'Administrator'], true, 'zaq12wsx');
     ...
     * @return void
     */
    public function test_userAudiobookInfoIncorrectCategoryKey(): void
    {
        /// step 1
        $user = $this->databaseMockManager->testFunc_addUser('User', 'Test', 'test@cos.pl', '+48123123123', ['Guest', 'User', 'Administrator'], true, 'zaq12wsx');
     ...
     * @return void
     */
    public function test_userAudiobookInfoIncorrectAudiobookId(): void
    {
        /// step 1
        $user = $this->databaseMockManager->testFunc_addUser('User', 'Test', 'test@cos.pl', '+48123123123', ['Guest', 'User', 'Administrator'], true, 'zaq12wsx');
     ...
     * @return void
     */
    public function test_userAudiobookInfoLogOut(): void
    {
        /// step 1
        $user = $this->databaseMockManager->testFunc_addUser('User', 'Test', 'test@cos.pl', '+48123123123', ['Guest', 'User', 'Administrator'], true, 'zaq12wsx');
        ...
        /// step 2
        $crawler = self::$webClient->request('POST', '/api/user/audiobook/info', content: json_encode($content));
