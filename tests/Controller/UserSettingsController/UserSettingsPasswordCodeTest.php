...
class UserSettingsPasswordCodeTest extends AbstractWebTest
{
    ...
    public function test_userSettingsPasswordCodeCorrect(): void
    {
        ...
        /// step 3
        $crawler = self::$webClient->request('PUT', '/api/user/settings/password/code', server : [
    ...
    public function test_userSettingsPasswordCodeChangeLogOut(): void
    {
        ...
        /// step 2
        $crawler = self::$webClient->request('PUT', '/api/user/settings/password/code', content: json_encode($content));
        /// step 3
