...
//
//        $notification1 = $this->databaseMockManager->testFunc_addNotifications([$user1, $user2], NotificationType::NEW_CATEGORY, $category1->getId(), NotificationUserType::SYSTEM, categoryKey: $category1->getCategoryKey());
