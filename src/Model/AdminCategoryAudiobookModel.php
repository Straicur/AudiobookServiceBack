...
class AdminCategoryAudiobookModel implements ModelInterface
{
     ...
     * @param bool $active
     */
    public function __construct(string $id, string $title, string $author, string $version, string $album, \DateTime $year, string $duration, string $size, int $parts, string $description, AudiobookAgeRange $age, bool $active)
    {
        $this->id = $id;
        $this->title = $title;
        $this->author = $author;
