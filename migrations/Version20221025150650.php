 ...
 */
final class Version20221025150650 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE audiobook_category ADD CONSTRAINT FK_EC2A724A727ACA70 FOREIGN KEY (parent_id) REFERENCES audiobook_category (id) ON DELETE CASCADE');
    }
