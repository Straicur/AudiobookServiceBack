...
APP_ENV=test symfony console audiobookservice:admin:add "Damian" "Mosiński" "admin@audio.com" "980921222" "zaq12wsx"
...
APP_ENV=test symfony console audiobookservice:users:create "Kamil" "Rekruter" "recq@audiobookback.icu" "980921228" "zaq12wsx" "User" "Guest" "Recruiter"
